...
function init()
	RegisterTool("p90", "P90", "MOD/demo/mods/C P90/vox/p90.vox")
	...
	gunsound = LoadSound("MOD/demo/mods/C P90/snd/p90.ogg")
	cocksound = LoadSound("MOD/demo/mods/C P90/snd/p90cock.ogg")
	reloadsound = LoadSound("MOD/demo/mods/C P90/snd/p90reload.ogg")
	dryfiresound = LoadSound("MOD/demo/mods/C P90/snd/dryfire.ogg")
	refillsound = LoadSound("MOD/demo/mods/C P90/snd/refill.ogg")

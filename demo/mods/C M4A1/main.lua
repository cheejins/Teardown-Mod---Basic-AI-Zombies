...
function init()
	RegisterTool("z-m4a1", "Z-M4A1", "MOD/demo/mods/C M4A1/vox/m4a1.vox")
	...
	gunsound = LoadSound("MOD/demo/mods/C M4A1/snd/m4.ogg")
	cocksound = LoadSound("MOD/demo/mods/C M4A1/snd/guncock.ogg")
	reloadsound = LoadSound("MOD/demo/mods/C M4A1/snd/reload.ogg")
	dryfiresound = LoadSound("MOD/demo/mods/C M4A1/snd/dryfire.ogg")
	refillsound = LoadSound("MOD/demo/mods/C M4A1/snd/refill.ogg")

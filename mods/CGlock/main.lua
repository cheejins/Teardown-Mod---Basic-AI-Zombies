...
function initGlock18()
	...
	RegisterTool("z-glock18", "Z-Glock 18", "MOD/mods/cglock/vox/glock.vox")
	...
	gunsound = LoadSound("MOD/mods/cglock/snd/deagle_shot.ogg")
	cocksound = LoadSound("MOD/mods/cglock/snd/pistolcock.ogg")
	reloadsound = LoadSound("MOD/mods/cglock/snd/deagle_reload.ogg")
	dryfiresound = LoadSound("MOD/mods/cglock/snd/dryfire.ogg")
	refillsound = LoadSound("MOD/mods/cglock/snd/refill.ogg")
end

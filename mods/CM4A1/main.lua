...
function initM4A1()
	RegisterTool("z-m4a1", "Z-M4A1", "MOD/mods/cm4a1/vox/m4a1.vox")
	...
	gunsound = LoadSound("MOD/mods/cm4a1/snd/m4.ogg")
	cocksound = LoadSound("MOD/mods/cm4a1/snd/guncock.ogg")
	reloadsound = LoadSound("MOD/mods/cm4a1/snd/reload.ogg")
	dryfiresound = LoadSound("MOD/mods/cm4a1/snd/dryfire.ogg")
	refillsound = LoadSound("MOD/mods/cm4a1/snd/refill.ogg")
